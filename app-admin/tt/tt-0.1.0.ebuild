...
SRC_URI="https://github.com/tarantool/tt/releases/download/${PV}/${P}-complete.tar.gz"
SRC_URI+=" https://github.com/tarantool/tt/releases/download/${PV}/${P}-deps.tar.xz"

# The project is licensed under BSD-2, other licenses are from its
# dependencies.
LICENSE="BSD-2 MIT Apache-2.0 BSD MPL-2.0 LGPL-3"
SLOT="0"
KEYWORDS="~amd64"
